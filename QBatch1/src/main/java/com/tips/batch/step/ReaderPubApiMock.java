...
public class ReaderPubApiMock implements ItemReader<List<FineDust>>
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(ReaderPubApiMock.class);
...
//        }
        ...
        try
        {
            ...
            StringBuilder urlBuilder = new StringBuilder("http://localhost:8081/pubfinedustlist");
...
//            }
            ...
            //fineDustStageMokeRepository.saveAll(fineDust);
